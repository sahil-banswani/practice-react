...
function App() {
  ...
  // it is basically used for optimization and store value in cache memo and runs the fn where called
  const passwordGenerator = useCallback( () => {
    let pass = ""
    let str = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghikllmnopqrstuvwxyz"
  ...
  //yeeh function ka kaam => ismai agr kuch bhi chnage ho to vapas se run krdo 
  useEffect(() => {
    passwordGenerator()
